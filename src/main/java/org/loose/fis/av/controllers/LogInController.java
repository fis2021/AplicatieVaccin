...
public class LogInController {
    ...
    public void handleLogInAction(javafx.event.ActionEvent actionEvent) {
        try {
            User LoggedInUser;
            LoggedInUser=UserService.logIn(usernameField.getText(),passwordField.getText());
            if(Objects.equals("Patient", LoggedInUser.getRole())) {
                ...
                if(Objects.equals("Manager", LoggedInUser.getRole()))
                {
                    Parent RegisterView = null;
                    try {
